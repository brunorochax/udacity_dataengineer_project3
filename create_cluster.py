"""This is the create_cluster module.
It will be responsible by redshift cluster creation.
"""
...
def main():
    ...
    and create the redshift cluster using parameters on sparkify.cfg
    ...
    try:
        ...
        print ('Cluster will be created, you can monitore it on your redshift console.')
