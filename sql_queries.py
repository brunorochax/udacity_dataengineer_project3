"""This is the sql_queries module.
It will be responsible by scripts for create tables and import data from sources.
"""
...
DB_ROLE_ARN = config.get('IAM_ROLE','DB_ROLE_ARN')
